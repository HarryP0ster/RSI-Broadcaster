...
namespace RSI_X_Desktop
{
    public partial class LangSelectDlg : Form
    {
        ...
        public LangSelectDlg()
        {
            ...
            foxLabelRoomName.Text = AgoraObject.GetComplexToken().GetRoomName;
        }

        internal static ReaLTaiizor.Controls.SkyButton CreateButton(string text, int height=35, int width=60) => new ReaLTaiizor.Controls.SkyButton()
        {
            Text = text,
            Height = height,
            Width = width
        ...
        private void buttonOk_Click(object sender, EventArgs e)
        {
            ...
            else if (NickName.Length > 10) //If you change this, consider also chaning limit in IChannel
            {
